...
class outdoorControl extends StatelessWidget {
  @override
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          InkWell(
                                            onTap: () {
                                              Provider.of<change>(context, listen: false).btn[0]
                                                  ? Provider.of<MqttProvider>(context, listen: false).publishMessage('home/control', '{"leds" : "off"}')
                                                  : Provider.of<MqttProvider>(context, listen: false).publishMessage('home/control', '{"leds" : "on"}');
                                              Provider.of<change>(context, listen: false).btn1();
                                            },
                                            child: Consumer<change>(
                                              builder: (context, changeProvider, child) {
                                                return control(
                                                  icon: Icons.lightbulb, isPressed: changeProvider.btn[0],
                                                  device: 'LED',
